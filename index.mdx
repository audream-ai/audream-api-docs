...
<CardGroup cols={2}>
  ...
  <Card title="Build optional artifacts" icon="wand-magic-sparkles" href="/api-reference/notes/generate-note-artifact">
    Generate epiphany, deep research, or podcast artifacts without replacing the note's primary Insights.
  </Card>
  <Card title="Ask across notes" icon="messages" href="/api-reference/ask/ask-workspace">
